...
#define NUMBER_OF_MODES  23 // ESP - Anzahl Datensätze in struct Data
#else
#define NUMBER_OF_MODES  7  // AVR - Anzahl Datensätze in struct Data
#endif
...
#ifdef OOK_MU_868
const uint8_t Config_OOK_MU_868[] PROGMEM = {
  /*
    Address Config = No address check
    Base Frequency = 868.349854
    CRC Autoflush = false
