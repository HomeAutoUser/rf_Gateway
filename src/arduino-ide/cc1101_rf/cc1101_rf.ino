...
#ifdef CC110x
const char TXT_VERSION[] PROGMEM = "V 2.0.1pre SIGNALduino compatible cc1101_rf_Gateway (2024-01-29) ";
#elif RFM69
const char TXT_VERSION[] PROGMEM = "V 2.0.1pre SIGNALduino compatible rfm69_rf_Gateway (2024-01-29) ";
#else
