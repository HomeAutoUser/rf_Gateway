...
class BitStore
{
  public:
    ...
    // bool moveLeft(const uint16_t begin); // warning: comparison between signed and unsigned integer expressions [-Wsign-compare]
...
template<uint8_t bufSize>
//bool BitStore<bufSize>::moveLeft(const uint16_t begin) // warning: comparison between signed and unsigned integer expressions [-Wsign-compare]
